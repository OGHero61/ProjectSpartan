package net.hero61.projectspartan.client.model.item.model.armor.airassault;
...
public class ModelAirAssaultHelmet<T extends LivingEntity> extends HumanoidModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation(ProjectSpartan.MOD_ID, "airassault_helmet"), "main");
	public ModelAirAssaultHelmet(ModelPart modelPart) {
		super(modelPart);
	}
